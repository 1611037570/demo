<template>
  <div class="p-1 rounded-4xl relative overflow-hidden bg-sf-modal">
    <!-- Tab列表容器 -->
    <div class="relative z-10 flex" @mouseleave="handleMouseLeave">
      ...
      <div
        ...
        :key="index"
        class="tab-item rounded-4xl py-1 px-2 relative z-10 flex-1 cursor-pointer text-center transition-all duration-100"
      ...
      <!-- 背景指示器，实现跟随动画效果 -->
      <div
        class="top-0 rounded-4xl absolute h-full bg-sf-theme"
