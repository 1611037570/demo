<template>
  <div
    class="flex items-end p-2.5 bg-white/20 mx-auto rounded-xl z-20 fixed translate left-1/2 -translate-x-1/2 transition-all duration-300 bottom-0 min-h-[60px] max-h-[60px] w-auto"
    ref="menuRef"
    :class="dockClass"
